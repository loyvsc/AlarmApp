...
namespace AlarmApp.Models
{
    ...
    public class Alarm : RealmObject
    {
        ...
        [Ignored] public string UserFriendlyFrequency { get => GetFrequencyAsReadableString(Frequency); }
        ...
        [Ignored] public TimeSpan EndTime { get => Time.Add(Duration); }
        public bool IsActive { get; set; }
        public DaysOfWeek Days { get; set; } = new DaysOfWeek();

        [Ignored] public bool OccursToday { get => Days.Equals(DateTime.Now.DayOfWeek); }
